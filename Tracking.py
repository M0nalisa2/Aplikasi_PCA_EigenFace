...
st.sidebar.info("Toleransi adalah ambang batas pengenalan wajah. Semakin rendah toleransi, semakin ketat pengenalan wajah. Semakin tinggi toleransi, semakin longgar pengenalan wajah.")
...
if choice == "Picture":
    st.title("Face Recognition PCA Muhammad Reki")
...
with st.sidebar.form(key='my_form'):
    ...
    submit_button = st.form_submit_button(label='RESET DATASET')
    if submit_button:
